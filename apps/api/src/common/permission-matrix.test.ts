...
const ROUTES: RouteCase[] = [
  ...
  { method: "PATCH", path: "/api/v1/hierarchy-templates/{id}", permission: "registry.manage", url: () => `/api/v1/hierarchy-templates/${randomUUID()}`, headers: X(), body: {} },
  ...
  { method: "GET", path: "/api/v1/workspaces/{ws}/naming-templates", permission: "workspace.member", url: () => `/api/v1/workspaces/${wsA}/naming-templates` },
  { method: "POST", path: "/api/v1/workspaces/{ws}/naming-templates", permission: "registry.manage", url: () => `/api/v1/workspaces/${wsA}/naming-templates`, body: {} },
  ...
  { method: "DELETE", path: "/api/v1/saved-views/{id}", permission: "workspace.member", url: () => `/api/v1/saved-views/${rid}`, headers: X() },
  { method: "POST", path: "/api/v1/exports", permission: "export.run", url: () => `/api/v1/exports`, headers: X(), body: {} },
  { method: "GET", path: "/api/v1/exports/{jobId}", permission: "export.run", url: () => `/api/v1/exports/${rid}`, headers: X() },
  ...
  { method: "GET", path: "/api/v1/assets/icons/{file}", permission: "workspace.member", url: () => `/api/v1/assets/icons/0190a000-0000-7000-8000-000000000000.svg`, headers: X() },
  ...
  { method: "POST", path: "/api/v1/envelopes/structure/preview", permission: "envelope.read", url: () => "/api/v1/envelopes/structure/preview", headers: X(), body: {} },
  { method: "POST", path: "/api/v1/envelopes/{id}/children", permission: "envelope.create", url: () => `/api/v1/envelopes/${rid}/children`, headers: X(), body: {} },
